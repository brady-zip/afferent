...
**Product release:** v0.1.0 at `279d6e47558612476752d81a2a4a844230d7a306`

**Scope:** Seven phases (1, 2, 2.1, 2.2, 2.3, 3, 4), 51 plans, 149 planned tasks.

This archive preserves the full roadmap. GSD's v1.0 planning label is distinct
from the immutable published product release v0.1.0. The stale Phase 1 plan
counter was reconciled to its eight actual plans and eight completion summaries.
