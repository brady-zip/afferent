...
const evidenceCreatedAt = Date.UTC(2026, 0, 14, 12);
const evidencePublishedAt = Date.UTC(2026, 0, 15, 12);
const fixturePost = {
  id: "post:keyboard",
  contractVersion: 3,
  ...
  planned: [
    {
      ...
      status: { key: "planned", label: "Planned" },
      currentStatusSince: evidencePublishedAt,
...
const changelogEntries = [
  {
    ...
    firstPublishedAt: evidencePublishedAt,
    updatedAt: evidencePublishedAt,
    links: [
      {
        contractVersion: 1,
        id: fixturePost.id,
...
const activity = [
  {
    ...
    postId: fixturePost.id,
    type: "status_change",
    occurredAt: evidencePublishedAt,
