...
INSTALL_JS_GLOBAL="/Users/bradywatkinson/dev/afferent/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/bradywatkinson/dev/afferent/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
