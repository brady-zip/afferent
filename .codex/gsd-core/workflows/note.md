...
- **Global scope**: `/Users/bradywatkinson/dev/afferent/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bradywatkinson/dev/afferent/.codex/notes/`)
...
2. Glob `/Users/bradywatkinson/dev/afferent/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bradywatkinson/dev/afferent/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bradywatkinson/dev/afferent/.codex/notes/` — works in any directory
