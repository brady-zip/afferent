...
ones). Reference: @/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/bradywatkinson/dev/afferent/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/bradywatkinson/dev/afferent/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/bradywatkinson/dev/afferent/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/bradywatkinson/dev/afferent/.codex/gsd-core/templates/spec.md.
