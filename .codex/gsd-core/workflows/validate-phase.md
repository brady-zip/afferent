...
```
Agent(
  prompt="Read /Users/bradywatkinson/dev/afferent/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bradywatkinson/dev/afferent/.codex/gsd-core/templates/VALIDATION.md`
