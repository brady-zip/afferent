...
<template>
@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/bradywatkinson/dev/afferent/.codex/gsd-core/workflows/transition.md`.
...
- Follow @/Users/bradywatkinson/dev/afferent/.codex/gsd-core/workflows/diagnose-issues.md
