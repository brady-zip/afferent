...
<required_reading>
@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/user-story-template.md
@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/spidr-splitting.md
@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
