...
**Verification depth scales with `asvs_level`** (see @/Users/bradywatkinson/dev/afferent/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
